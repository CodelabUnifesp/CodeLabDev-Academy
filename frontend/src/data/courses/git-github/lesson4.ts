...
const lesson4: Lesson = {
  ...
  content: [
    ...
    { type: 'text', content: 'Quando queremos que uma pasta do nosso computador seja gerenciada pelo Git, usamos o comando:'},
    { type: 'subtext', content: '<strong class="code-text">git init</strong>'},
    ...
    { type: 'list', content: 'Centralizar o código-fonte/nCompartilhar com outros desenvolvedores/nDefinir um ponto de partida comum para o projeto'},
